...
//             We’ve sent a confirmation email to your registered email address. Our recruitment team will review your 
//             application and get back to you within 7–10 working days regarding the next steps.
//             <b>Please don’t forget to check your spam or junk folder in case the email ends up there.</b>
//             </p>
...
export default async function SuccessPage({
  ...
  searchParams: Promise<{ name?: string; job?: string }>
}) {
  ...
  const job = resolvedParams?.job || "the position"
